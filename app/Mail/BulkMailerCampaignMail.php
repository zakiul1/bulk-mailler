...
class BulkMailerCampaignMail extends Mailable
{
    ...
    public function build(): self
    {
        ...
        $mail->html($htmlBody)
            ...
            ->withSymfonyMessage(function (Email $message) use ($htmlBody, $textBody) {
    ...
    protected function normalizeHtmlBody(string $html): string
    {
        ...
        return '<!DOCTYPE html>' . '<html lang="en">' . '<head>' . '<meta charset="UTF-8">'
            ...
            . '<div style="max-width:700px;margin:0 auto;padding:16px;line-height:1.6;">' . $html . '</div>'
            . '</body>' . '</html>';
    }
    ...
    {
        $name = $this->
            sanitizeHeaderText($this->smtp->from_name);
