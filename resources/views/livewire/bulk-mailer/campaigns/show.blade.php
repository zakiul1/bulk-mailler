    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div class="border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="mt-2 text-lg font-semibold text-zinc-900 dark:text-white">{{ number_format($this->totals['delivered']) }}</div>
            </div>

            <div class="border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                <div class="text-xs text-zinc-500 dark:text-zinc-400">Open Events</div>
                <div class="mt-2 text-lg font-semibold text-zinc-900 dark:text-white">{{ number_format($this->totals['opens']) }}</div>
            </div>

            <div class="border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                <div class="text-xs text-zinc-500 dark:text-zinc-400">Click Events</div>
                <div class="mt-2 text-lg font-semibold text-zinc-900 dark:text-white">{{ number_format($this->totals['clicks']) }}</div>
            </div>

            <div class="border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                <div class="text-xs text-zinc-500 dark:text-zinc-400">Bounce Events</div>
                <div class="mt-2 text-lg font-semibold text-zinc-900 dark:text-white">{{ number_format($this->totals['bounces']) }}</div>
            </div>
        </div>
