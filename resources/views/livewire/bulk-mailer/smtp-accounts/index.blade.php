        ...
        <div
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
                    Create, edit, test, enable, disable, monitor health, and organize SMTP accounts for campaign
                    rotation.
                </p>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-4 align-top">
                                    <div class="flex flex-wrap justify-end gap-2">
                                        ...
                                        <button type="button" wire:click="resetHealth({{ $row->id }})"
                                            class="border border-zinc-300 px-3 py-1.5 text-xs text-zinc-900 hover:bg-zinc-100 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-800">
                                            Reset Health
                                        </button>

                                        @if ($row->auto_disabled_at)
                                            <button type="button" wire:click="reEnable({{ $row->id }})"
                                        ...
                                        <button type="button" wire:click="toggleStatus({{ $row->id }})"
                                            class="border border-zinc-300 px-3 py-1.5 text-xs text-zinc-900 hover:bg-zinc-100 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-800">
    ...
    @if ($showFormModal)
        <div class="fixed inset-0 z-40 overflow-y-auto bg-black/50">
            <div class="flex min-h-full items-start justify-center px-4 py-6">
                <div
                    class="flex max-h-[90vh] w-full max-w-4xl flex-col border border-zinc-200 bg-white dark:border-zinc-700 dark:bg-zinc-900">
                    <div
